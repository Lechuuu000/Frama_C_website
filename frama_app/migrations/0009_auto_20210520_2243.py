...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('frama_app', '0008_auto_20210520_1420'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='section',
            name='status',
            field=models.CharField(blank=True, choices=[('lightgray', 'Unknown'), ('mediumseagreen', 'Valid'), ('red', 'Failed'), ('mediumslateblue', 'Timeout')], max_length=20),
        ),
        migrations.AlterField(
            model_name='user',
            name='name',
